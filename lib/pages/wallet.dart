    ...
    return Column(
      children: [
        GetBuilder<WalletController>(builder: (context) {
          return _walletController.walletflower.isEmpty
              ? Expanded(
                  child: Column(
                    ...
                    SizedBox(
                      ...
                      child: FadeInUp(
                        ...
                        child: Lottie.network(
                            "https://lottie.host/3e79a3bf-e709-48da-b971-a9c7d458cc61/uj7hXSieTt.json",
                            animate: true),
                      ),
                    ),
                    const SizedBox(
                    ...
                    children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Center(
                                    child: Text(
                                  "Total Item : ${_walletController.walletflower.length}",
                                  style: GoogleFonts.lato(
                                      fontSize: 19,
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          itemCount: _walletController.walletflower.length,
                              ...
                              child: Stack(children: [
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Hero(
                                          tag: _walletController
                                              .walletflower[index].id,
                                          child: Image.asset(
                                            _walletController.walletflower[index].img,
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
                                ...
                                Positioned(
                                  ...
                                  child: FadeInLeft(
                                    ...
                                    child: Text(
                                      _walletController.walletflower[index].title,
                                ...
                                Positioned(
                                  ...
                                  child: FadeInLeft(
                                    ...
                                    child: Text(
                                      _walletController.walletflower[index].subtitle,
                                      style: GoogleFonts.oxygen(
                                ...
                                Positioned(
                                  ...
                                  child: FadeInLeft(
                                    ...
                                    child: Text(
                                      "\$${_walletController.walletflower[index].price.toStringAsFixed(2)}",
                                      style: GoogleFonts.oxygen(
                                          color: Colors.black,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 23),
      ...
      actions: [
        GetBuilder<WalletController>(builder: (context) {
          return Padding(
              ...
              child: _walletController.walletflower.isNotEmpty
                  ? FadeInRight(
                      delay: const Duration(milliseconds: 300),
                      child: IconButton(
                        onPressed: () {
